...
import '../src/components/range.css'
...
class App extends Component {
  ...
  // trackprogressstyle = linear-gradient('to right, blue ${this.state.played}, yellow ${this.state.played}')
  ...
  render() {
    ...
    const trackProgressStyling = `linear-gradient(to right, orange ${currentProgress}%, gray ${currentProgress}%)`;
                ...
                <td>
                  <div className='slider-horizontal'>
                    {/* <Slider
                      ...
                      onChange={() => { this.handleSeekChange(); this.onChangeHandle(); }}
                    /> */}
                  </div>
